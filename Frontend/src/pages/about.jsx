  ...
  return (
    <div className="relative min-h-screen bg-white dark:bg-gray-900 overflow-hidden">
      <section
        id="about"
        ref={containerRef}
        className="relative min-h-screen py-20 md:flex hidden  items-center bg-white dark:bg-gray-900 overflow-hidden "
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            <motion.div className="md:col-span-2 pr-4 mt-16" style={{ y, opacity }}>
              <motion.div
                className="relative "
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
      ...
      <section
        id="about"
        ref={containerRef}
        className="relative min-h-screen py-12 flex md:hidden items-center bg-white dark:bg-gray-900 overflow-hidden "
      >
        {/* Animated background elements */}
        <div className="absolute inset-0 overflow-hidden">
          {[...Array(5)].map((_, i) => (
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col space-y-10">
            ...
            >
              ...
              >
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg inline-flex items-center gap-2 transition-colors text-sm"
                >
                  <CodeIcon size={14} />
                  Work With Me
                </motion.a>
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 border border-indigo-600 text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-lg inline-flex items-center gap-2 transition-colors text-sm"
                >
              ...
              <motion.div variants={fadeInUp} className="mt-6 flex gap-4">
                <motion.a
                  ...
                  rel="noopener noreferrer"
                  whileHover={{ y: -5, scale: 1.1 }}
                  className="w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                >
                  <GithubIcon size={18} />
                </motion.a>
            ...
            >
                ...
                {traits.map((trait, index) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div
                        className={`p-2 rounded-lg bg-gradient-to-br ${trait.color} text-white`}
                      >
                        {trait.icon}
                      </div>
                      <div>
              ...
              {/* Background decorative elements */}
              <div className="absolute -z-10 -top-4 right-2 w-24 h-24 bg-indigo-100/40 rounded-full blur-xl" />
              <div className="absolute -z-10 bottom-10 left-2 w-20 h-20 bg-emerald-100/40 rounded-full blur-xl" />
            </motion.div>
          </div>
        </div>
      </section>
